...
// this ingredient in OFF/CoFID/the live lookup, so the model estimates
// macros directly rather than the app logging a silent zero. Same
// no-separate-fallback-tier model choice as parse-description.ts (ADR
// 0005); always produces a needs_review item at the call site regardless of
