...
// C6-B1 direction settled on the Dashboard (ticket #29, branch
// prototype/dashboard-look) and carried into the description-result screen
// (ticket #30, branch prototype/log-description-look): cool-indigo
// pastel-gradient-blob backdrop, frosted glass, Newsreader Display. Ported
// verbatim (not re-derived, and not re-run against the taste library) so all
// three logging screens read as the same app. What varies across the three
// variants here is how the photo relates to the extracted values, not the
// colour.
export const theme = {
  pageBg: "bg-[#f5f4fa]",
