...
export const VARIANTS: { key: VariantKey; name: string }[] = [
  { key: "A", name: "frosted-glass-over-photo" },
  { key: "B", name: "pastel-sparkline-raised-fab" },
  { key: "C", name: "pastel-gradient-blob-backdrop" },
  { key: "D", name: "cream-serif-log-flow" },
];
...
export function PrototypeSwitcher({
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-full bg-neutral-900 px-3 py-2 text-white shadow-[0_8px_30px_rgba(0,0,0,0.35)] ring-1 ring-white/10">
      <button
        type="button"
